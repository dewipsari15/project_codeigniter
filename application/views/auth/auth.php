...
<head>
    ...
    <style>
        ...
        * {
        ...
        .overlay {
            background: #000080;
            background: -webkit-linear-gradient(to right, #00FFFF, #000080);
            background: linear-gradient(to right, #00FFFF, #000080);
        ...
        <div class="overlay-container">
            <div class="overlay">
                ...
                <div class="overlay-panel overlay-right">
                    <h1>Halo teman!</h1>
                    <p>Silahkan Registrasi jika belum punya akun</p>
