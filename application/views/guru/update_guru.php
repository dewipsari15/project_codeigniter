        ...
        <div class="home-section">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="row" action="<?php echo base_url('guru/aksi_update_guru'); ?>" enctype="multipart/form-data" method="post">
                        <input type="hidden" name="id" value="<?php echo $data_guru->id ?>">
                            ...
                            <div class="mb-3 col-6">
                                ...
                                <select class="form-select" aria-label="Default select example" name="gender">
                                    <option selectedvalue="<?php echo $data_guru->gender ?>"><?php echo $data_guru->gender ?></option>
