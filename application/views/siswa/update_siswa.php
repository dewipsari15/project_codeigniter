...
<body>
  <div class="d-flex">
        ...
        <div class="home-section">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="row" action="<?php echo base_url('siswa/aksi_update_siswa'); ?>" enctype="multipart/form-data" method="post">
                        <input type="hidden" name="id_siswa" value="<?php echo $data_siswa->id_siswa ?>">
                            ...
                            <div class="mb-3 col-6">
                                ...
                                <select class="form-select" aria-label="Default select example" name="gender">
                                    <option selectedvalue="<?php echo $data_siswa->gender ?>"><?php echo $data_siswa->gender ?></option>
    ...
    <script>
        const successMessage = "<?php echo $this->session->flashdata('berhasil_mengupdate'); ?>";
